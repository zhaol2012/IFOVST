...
/* 		onGetSta: function () {
			let pathTmp = "(p_uname='%uname%',p_datetime_from=datetimeoffset'%dtfrom%',p_datetime_to=datetimeoffset'%dtto%')";
			...
			let pathReq = "/IFStats" + pathTmp + "/Set?$format=json";
			let bindPath = "/IFStats" + pathTmp + "/Set";
			let outthis = this;
		...
		onSearch: function (oEvent) {
			//	let oFilter = this.byId("smartFilterBar");
			//	let sBindPath = oFilter.getParameterBindingPath();
			let sBindPath = oEvent.getSource().getParameterBindingPath();
			this.ifstatab.setTableBindingPath(sBindPath);
